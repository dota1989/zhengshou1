...
//		UsernamePasswordToken tranToken = (UsernamePasswordToken) token;
//		
//		String username = tranToken.getUsername();
...
//		
//		SimpleAuthenticationInfo info = new SimpleAuthenticationInfo(user,password,"BosRealm");
//		
//		return info;
